...
export default function ExerciseVideos({ exerciseVideos, name }) {
        ...
        >
            <div className="thumbnail relative overflow-hidden rounded-md">
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    <AiFillPlayCircle className="text-orange-600 text-6xl" />
                </div>
            </div>
    ...
    return (
        <div className='p-4 sm:p-12 my-2'>
            <h4 className='font-bold text-xl md:text-2xl xl:text-3xl mb-4'>Watch <span className='capitalize text-orange-600'>{name}</span> exercise videos</h4>
